...
1.  [Preface](#org9b9a4d5)
2.  [Package management](#orgd95b1c6)
    1.  [straight.el](#org05c7f3f)
        1.  [org-mode hack](#orga98bddb)
        2.  [hydra](#org5b5e50d)
    2.  [use-package](#org15dbbef)
        1.  [use-config macro](#orgaf3e7e2)
    3.  [no-littering](#org59ef566)
3.  [Configuration](#org674828a)
    1.  [Helpers](#orgd9590ce)
        1.  [bug-hunter](#orgdd8eb7e)
        2.  [general](#orgc9576f4)
        3.  [lib](#org4f45b71)
    2.  [Emacs](#orgf39cbe3)
        1.  [Default](#org685084b)
        2.  [Look](#org96ab9bf)
        3.  [Navigation](#orgade154e)
        4.  [OS Integration](#orgc63f90b)
        5.  [Extensible Interfaces](#orgf0681bb)
        6.  [Saving](#org00ec3c3)
    3.  [Editing](#org8b41c65)
        1.  [Prelude-esque](#orge390bf6)
        2.  [Visual line](#orgef2d26a)
        3.  [Pairs](#orgf08dee1)
        4.  [Snippets](#orga79f893)
        5.  [Jumping](#orge01f00d)
    4.  [Programming](#org49e79cf)
        1.  [Defaults](#org326ba1a)
        2.  [LSP/DAP family](#orge25d3c1)
        3.  [Projectile](#org7ce69b6)
        4.  [Company](#orgb8a2fb7)
        5.  [Outline/shine](#org3335ab7)
        6.  [Flycheck](#org317eaa4)
        7.  [Fly/ispell](#org04933e8)
    5.  [Languages](#org0bf6c61)
        1.  [Emacs Lisp](#org5de021a)
        2.  [Haskell](#org0b74447)
        3.  [Nix](#org601c434)
        4.  [TeX/LaTeX](#org1c3395c)
        5.  [Markdown](#orga06c4f8)
        6.  [Python](#org7dd27b0)
        7.  [Rust](#orgdfe7cc8)
        8.  [Shell](#orgd6fc9df)
    6.  [Misc](#orgcaea7d8)
        1.  [Git/Magit](#org77d8217)
        2.  [Music/MPD](#org386e7b5)
        3.  [Mail](#org781f68a)
        4.  [Org](#orgb21d438)
        5.  [RSS/Elfeed](#org026f662)
4.  [End](#org9b8b668)
...
Headers are grouped by their most significant functionality. If no logical order is present, alphabetical order should be upheld. [TODO] <sup><a id="fnr.5" class="footref" href="#fn.5">5</a></sup>
...
For this reason they have to be loaded very early during the initialization. <sup><a id="fnr.6" class="footref" href="#fn.6">6</a></sup>
...
Other than that there is also hydra, a package for defining colorful keyboard-centric pop-up menus and evil, the extensible vi layer. <sup><a id="fnr.8" class="footref" href="#fn.8">8</a></sup>
...
The [Emacs Prelude](https://github.com/bbatsov/prelude#helm) project, among other things, provides a set of helpful and generic keybindings for editing text.
...
1.  Dictionaries
    ...
    If not, default to "en<sub>US</sub>".
...
I have also written one of my own, [org-pretty-jump](straight/repos/org-pretty-jump/).
...
<sup><a id="fn.1" href="#fnr.1">1</a></sup> Why? <https://www.anishathalye.com/2014/08/03/managing-your-dotfiles/>

<sup><a id="fn.2" href="#fnr.2">2</a></sup> extensions, packages, collections of elisp code, &#x2026;

<sup><a id="fn.3" href="#fnr.3">3</a></sup> some more context can be found [here](https://github.com/raxod502/straight.el#installing-org-with-straightel)

<sup><a id="fn.4" href="#fnr.4">4</a></sup> 't' in this case may also be replaced with a symbolic package name or any valid straight.el recipie

<sup><a id="fn.5" href="#fnr.5">5</a></sup> because of VC tracking, but this should not limit refactoring

<sup><a id="fn.6" href="#fnr.6">6</a></sup> this could be changed by always using use-package

<sup><a id="fn.7" href="#fnr.7">7</a></sup> while dired is technically used to find files, it is flexible enough to warrant being but under `Misc`

<sup><a id="fn.8" href="#fnr.8">8</a></sup> evil might sound like a prime candidate for the `Editing` section, but because it also provides utilities like a command prompt and global keybinds, I choose to put it unter `Integration`
