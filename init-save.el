...
;;;; window-management/navigation (todo)
;;;;;; shackle
...
(general-define-key
 ...
 "C-j" (lambda () (interactive) (evil-window-move-very-bottom))
...
;; (evil-collection-define-key '(insert normal emacs) 'helm-map
...
(general-define-key
  ...
  [double-down-mouse-1] 'mouse-set-point)
...
(add-hook 'helm-mode-hook 'evil-insert)
