    ...
    `(progn
       ...
       (quote (,fun-name
               :wk ,(concat (symbol-name action)
                            "-"
                            ;; TODO: dash.el
                            (mapconcat (lambda (it) (format "%s" it)) args "-")))))))
...
;; [TODO: make sure this properly finds the last char]
...
; (defface org-canceled '(:background red) "")
; (defface org-maybe    '(:background magenta) "")
