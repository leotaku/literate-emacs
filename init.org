...
** early load
This subtree contains packages that don't necessarily have anything to do with package management, but need to be loaded as early as possible.
...
<2019-03-26 Tue>
*** TODO shell-command w/o newline
<2019-03-26 Tue>#
