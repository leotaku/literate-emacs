...
Important concepts include window management, buffer management, finding files [fn:dired-where] as well as automatic grouping and skipping of buffers.
...
Dired is also very extensible through custom keybindings and extensions, I use a lot of them.
